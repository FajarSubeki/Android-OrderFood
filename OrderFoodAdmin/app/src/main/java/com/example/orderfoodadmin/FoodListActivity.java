...
import com.example.orderfoodadmin.ViewHolder.FoodViewHolder;
...
public class FoodListActivity extends AppCompatActivity {
    ...
    private void showAddFoodDialog() {
        ...
        btnSelect = add_menu_layout.findViewById(R.id.btnSelect2);
        btnUpload = add_menu_layout.findViewById(R.id.btnUpload2);
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            imageFolder.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    // setvalue for new Category if image upload and we can get donwload link
                                    newFood = new Food();
